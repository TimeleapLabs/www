<script lang="ts">
	...
	const activeClass = 'md:bg-blue-600';
...
<Navbar
	class="bg-[rgba(0,0,0,.4)] text-white flex rounded-none! py-3 px-2 md:px-16 backdrop-blur-xl fixed top-0 w-full z-50 max-w-[100vw]"
>
