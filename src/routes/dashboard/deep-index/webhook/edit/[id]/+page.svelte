<script>
  ...
  $: if (hookFromId) {
    $updateValues = {
      ...
      confirmations: hookFromId.confirmations || 0,
    };
  }
                              ...
                              <div use:fixLabelTooltip>
                                <Tooltip triggerText="R-API endpoint">
                                  <p>
                                    ...
                                    endpoint. You can incorporate
                                    &#123;event&#125; into your URL, and the
                                    R-API will substitute it with the name of
                        ...
                        <Column>
                          {#if hookFromId}
                            <NumberInput
                              ...
                              label="Confirmations"
                              name="confirmations"
                              helperText="Deep Index waits for {$updateValues.confirmations ||
