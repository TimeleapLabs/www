		...
		<Row>
			...
			<Column>
				<Grid fullWidth>
					...
					<Row>
						<Column>
							<Button kind="secondary" href="/docs/services/deep-index/sync" icon={Book}>
								Documentation
							</Button>
				...
				<DataTable {headers} rows={userSyncTasks} {pageSize} {page} sortable>
					<Toolbar>
						<ToolbarContent>
							...
							<ToolbarMenu>
								<ToolbarMenuItem primaryFocus href="/docs/services/deep-index/sync">
									Documentation
								</ToolbarMenuItem>
							</ToolbarMenu>
							<Button icon={Add} href="/dashboard/deep-index/sync/new">Create Task</Button>
						</ToolbarContent>
					</Toolbar>
					<svelte:fragment slot="cell" let:row let:cell>
						{#if cell.key === 'actions'}
							<Link icon={UpdateNow} href="/dashboard/deep-index/sync/edit/{row.id}">Update</Link>
