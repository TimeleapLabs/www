<script>
	...
	$: if (refCode) {
		referralLink = `https://old.timeleap.swiss/?ref=${refCode}`;
		referralLinkToDocs = `https://old.timeleap.swiss/docs/?ref=${refCode}`;
	}
				...
				<div class="stick sidebar">
					<Tile class="blue-tile">
						<div class="form-info">
							...
							<p class="body-02">Earn up to 20% by promoting and referring clients to Kenshi.</p>
						</div>
					</Tile>

					<div class="buttons">
						<Button kind="secondary" href="/docs" icon={Information}>Learn about Kenshi</Button>
					</div>
				</div>
			</Column>
			<Column>
				<Grid>
					...
					<Row>
						<Column>
							<p>
								Who are you? If you choose one of business partner or content creator options be
								sure to read
							...
							<div class="persons">
								<TileGroup on:select={selectRefType} legend="Referrer type">
									{#each persons as person}
										<RadioTile value={person.id} checked={refType === person.id}>
											<div class="person">
					...
					<Row>
						<Column>
							<ExpressiveHeading size={2}>Contact Information</ExpressiveHeading>
						</Column>
					</Row>
					<Row>
						<Column>
							Let us know how we can contact you if needed. We respect your privacy, so this field
							is completely optional.
						</Column>
					</Row>
					<Row>
						<Column>
							<TextInput bind:value={email} labelText="Email" placeholder="Your email address" />
						</Column>
					</Row>
					<Row>
						<Column>
					...
					<Row>
						<Column>
							<p>
								Tell us how you promote our brand or products. Be sure to include links so we can
								find your content. Your referral type will fall back to "Regular" if we cannot
								verify your content using the information you provide here.
							</p>
						</Column>
					</Row>
					<Row>
					...
					{#if referralLink}
						<Row>
							<Column>
								<ExpressiveHeading size={2}>Your referrer links</ExpressiveHeading>
							</Column>
						</Row>
						<Row>
							<Column>
								Share these links with your followers or customers to start earning commissions.
								These links aren't valid unless you submit the form!
							</Column>
						</Row>
						<Row>
							<Column>
